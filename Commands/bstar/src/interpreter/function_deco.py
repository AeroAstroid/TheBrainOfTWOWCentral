...
from Commands.bstar.src.interpreter.function import Function
from Commands.bstar.src.interpreter.functions.args import args
from Commands.bstar.src.interpreter.functions.array import array
from Commands.bstar.src.interpreter.functions.choose import choose
from Commands.bstar.src.interpreter.functions.choosechar import choosechar
from Commands.bstar.src.interpreter.functions.comment import comment
from Commands.bstar.src.interpreter.functions.compare import compare
from Commands.bstar.src.interpreter.functions.concat import concat
from Commands.bstar.src.interpreter.functions.define import define
from Commands.bstar.src.interpreter.functions.find import find
from Commands.bstar.src.interpreter.functions.func import func
from Commands.bstar.src.interpreter.functions.global_func import global_func
from Commands.bstar.src.interpreter.functions.if_func import if_func
from Commands.bstar.src.interpreter.functions.import_func import import_func
from Commands.bstar.src.interpreter.functions.index import index
from Commands.bstar.src.interpreter.functions.setindex import setindex
from Commands.bstar.src.interpreter.functions.j import j
from Commands.bstar.src.interpreter.functions.join import join
from Commands.bstar.src.interpreter.functions.joinall import joinall
from Commands.bstar.src.interpreter.functions.length import length
from Commands.bstar.src.interpreter.functions.loop import loop
from Commands.bstar.src.interpreter.functions.randint import randint
from Commands.bstar.src.interpreter.functions.random_func import random_func
from Commands.bstar.src.interpreter.functions.range_func import range_func
from Commands.bstar.src.interpreter.functions.repeat import repeat
from Commands.bstar.src.interpreter.functions.replace import replace_func
from Commands.bstar.src.interpreter.functions.round import round_func
from Commands.bstar.src.interpreter.functions.slice import slice_func
from Commands.bstar.src.interpreter.functions.split import split
from Commands.bstar.src.interpreter.functions.time_func import time_func
from Commands.bstar.src.interpreter.functions.try_func import try_func
from Commands.bstar.src.interpreter.functions.type_func import type_func
from Commands.bstar.src.interpreter.functions.user_func import user_func
from Commands.bstar.src.interpreter.functions.userid import userid
from Commands.bstar.src.interpreter.functions.username import username
from Commands.bstar.src.interpreter.functions.var import var
from Commands.bstar.src.interpreter.functions.while_func import while_func
from Commands.bstar.src.interpreter.functions.block import block
from Commands.bstar.src.interpreter.functions.return_func import return_func
from Commands.bstar.src.interpreter.functions.raise_func import raise_func

from Commands.bstar.src.interpreter.functions.arrays.map_func import map_func
from Commands.bstar.src.interpreter.functions.arrays.max_func import max_func
from Commands.bstar.src.interpreter.functions.arrays.min_func import min_func
from Commands.bstar.src.interpreter.functions.arrays.randomizer import randomizer
from Commands.bstar.src.interpreter.functions.arrays.sort_func import sort_func

from Commands.bstar.src.interpreter.functions.math.abs import abs_func
from Commands.bstar.src.interpreter.functions.math.add import add
from Commands.bstar.src.interpreter.functions.math.ceil import ceil
from Commands.bstar.src.interpreter.functions.math.div import div
from Commands.bstar.src.interpreter.functions.math.factorial import factorial
from Commands.bstar.src.interpreter.functions.math.floor import floor
from Commands.bstar.src.interpreter.functions.math.log import log
from Commands.bstar.src.interpreter.functions.math.math import math_func
...
from Commands.bstar.src.interpreter.functions.math.cos import cos
from Commands.bstar.src.interpreter.functions.math.sin import sin
from Commands.bstar.src.interpreter.functions.math.tan import tan
